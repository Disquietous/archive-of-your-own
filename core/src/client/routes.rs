...
pub const ROUTES: &[Route] = &[
    ...
    Route { key: "comment_thread", template: "/comments/{ID}",
            label: "One comment and its replies" },
    ...
    Route { key: "collection_bookmarks", template: "/collections/{NAME}/bookmarks?page={PAGE}",
    ...
    Route { key: "series_bookmarks", template: "/series/{ID}/bookmarks",
            label: "Series bookmark form" },
...
mod tests {
    ...
    fn classifies_the_documented_shapes() {
        ...
        let cases = [
            ...
            (format!("{base}/comments/99001"), "comment_thread"),
            ...
            (format!("{base}/collections/foo/bookmarks?page=2"), "collection_bookmarks"),
