...
final class AppState {
    ...
    // MARK: - User profiles (author subscribe / block / mute)
    ...
    func checkSubscriptions() async {
        ...
        do {
            ...
            // subscriptions (same UserDefaults key both platforms use).
            let follows = UserDefaults.standard.stringArray(forKey: "followedAuthors") ?? []
